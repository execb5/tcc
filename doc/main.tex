...
%----------------------------------------------------------------
\title{Reconhecimento de Placas de Carro em Sistema Embarcado}
      {Car License Plate Recognition in Embedded System}
...
\label{cha:configuracao}
\input{./chapters/configuracao.tex}

\chapter{Cronograma}
\label{cha:crono}
\input{./chapters/cronograma.tex}

\chapter{Recursos Necessários}
\label{cha:recursos}
\input{./chapters/recursos_necessarios.tex}
