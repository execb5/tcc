...
The identification and control of vehicles is used in many different areas, ranging from automated payment services, like toll booths, to more critical applications, such as border security and traffic vigilance systems. With the constant growth of the Brazilian car fleet, applications used to help in this line of work become more necessary every day. With that in mind, it's proposed in this paper a solution of an embedded application for automatic license plate recognition, aiming for the growing necessity of control in the area and the peculiarities of the Brazilian license plates, that preclude the utilization of tools configured for international license plates, making it a necessity to have local researches on this subject.
\end{abstract}
...
\input{./chapters/fundamentacao_teorica.tex}
...
\input{./chapters/componentes.tex}
...
\input{./chapters/resultados_obtidos.tex}

% \chapter{Dificuldades Encontradas}
% \label{cha:dificuldades}
% \input{./chapters/dificuldades_encontradas.tex}

\chapter{Conclusão e Trabalhos Futuros}
\label{cha:conclusao}
\input{./chapters/comentarios_finais.tex}
