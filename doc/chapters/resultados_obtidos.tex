...
symbolic x coords={Única,Sequencial,Pipeline},
xtick=data,
nodes near coords,
nodes near coords align={vertical},
]
\addplot coordinates {(Única, 3.19) (Sequencial, 27.91) (Pipeline, 14.11)};
\addplot coordinates {(Única, 38.89) (Sequencial, 342.99) (Pipeline, 63.57)};
\legend{Macbook Pro, Raspberry Pi}
\end{axis}
\end{tikzpicture}
