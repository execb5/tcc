...
A área de reconhecimento automático de placas de carros é tão estudada, que alguns autores fizeram estudos comparando alguns dos mais comuns algoritmos para solucionar o problema.
...
Em S Du~\cite{s2013automatic} também foi feito um estudo semelhante. Foi feita uma pesquisa categorizando os métodos existentes, de acordo com as características de cada um. Destes métodos, foram analisados seus prós e contras, e foram comparados sua performance de reconhecimento e velocidade de processamento.

Escrever mais sobre S Du~\cite{s2013automatic} aqui!!
